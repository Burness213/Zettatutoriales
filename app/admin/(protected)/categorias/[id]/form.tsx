...
export default function EditarCategoriaForm({ category }: { category: any }) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold font-montserrat text-white">Editar Categoría</h1>
          <p className="text-slate-400 mt-1">Actualiza los datos de la categoría</p>
        </div>
        <Link 
